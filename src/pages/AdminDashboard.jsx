          ...
          <div className="flex flex-col sm:flex-row gap-3 pt-2">
            {isAuthenticated && (
              <button
                ...
                className="flex-1 py-3.5 rounded-2xl bg-gradient-to-r from-red-700 to-red-600 hover:from-red-600 hover:to-red-500 text-white font-bold uppercase font-cartoon tracking-wider transition-all cursor-pointer shadow-lg shadow-red-700/30"
              >
                Cerrar Sesión
              </button>
            )}
            <button
              ...
              className="flex-1 py-3.5 rounded-2xl bg-white/10 hover:bg-white/15 text-linen-200 font-bold uppercase font-cartoon tracking-wider transition-all cursor-pointer border border-white/10"
            >
              Volver a la Web
            </button>
          </div>
